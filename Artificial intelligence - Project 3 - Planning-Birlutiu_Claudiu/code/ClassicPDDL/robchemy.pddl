...
(define (domain robchemy)
    ...
    (:action first-reactant 
        ...
        :precondition (and  (contains-s-rec ?s ?r)     ;;presupune ca e plin paharul de masurat
                             ...
                             (hold-e ?a2 ?e)
                             (used ?r)                 ;;recipientul e plin cu substanta respectiva; adica nu e gol și a rămas nespalat
                        )
    ...
    (:action second-reactant 
        ...
        :precondition (and  (contains-s-rec ?s ?r)    ;;e plin paharul de masurat
                            (hold ?a1 ?r)             ;;recipientul de masurat e in bratul robotului 
    ...
    (:action clean-recipient
        ...
        :effect (and (empty-clean ?r)
                ...
                (forall (?s - reactant) (when (and (contains-s-rec ?s ?r)) (not (contains-s-rec ?s ?r) )))   ;;se vor goli si substantele din recipient 
                 (increase (total-cost) 3)   ;;e mai costisitor sa se spele paharul de masurat
            )
    )
    ...
    (:action check-reactie-baza-acid
        ...
        :effect (and (result-sare ?e) (increase (total-cost) 1))
    )
    ...
    (:action check-reactie-baza-sare
        ...
        :effect (and (result-baza-isnolubila ?e) (increase (total-cost) 1))
    )
    ...
    (:action check-reactie-acid-sare
        ...
        :effect (and (result-precipitat ?e) (increase (total-cost) 1))
    )
